...
export const layout_configuration = flag<OptimizelyFlag<{
   ...
   *
   * @defaultValue /assets/cohnreznick-logo-white.svg
   * @opti string
   */
  logo: string,
  /**
  ...
  theme_switcher: boolean
    ...
    defaultValue: {"_enabled":false,"logo":"/assets/cohnreznick-logo-white.svg","theme_switcher":true},
    async decide() {
        "use server"
    ...
    options: [
        {
            label: "Off",
            value: {"_enabled":false,"logo":"/assets/cohnreznick-logo-white.svg","theme_switcher":true}
        }
    ]
})
